  ...
  <div class="exam-page" @contextmenu.prevent>
    ...
    <div v-else class="exam-container">
      <div class="exam-header">
        ...
        <h1 class="exam-title">NINJA DDx</h1>
        <span class="exam-badge">DDx Approach</span>
      </div>
      <div class="exam-body">
        <div class="coming-soon">
          <div class="cs-icon">🔍</div>
          <h2>กำลังพัฒนาเนื้อหา</h2>
          <p>ระบบฝึกวินิจฉัยแยกโรค สำหรับ NL และ MEQ</p>
          <p class="cs-features">• ฝึกคิด Differential Diagnosis<br>• 3 โหมดเกม ท้าทายสมอง<br>• Approach แบบเป็นระบบ</p>
        </div>
      </div>
    </div>
  </div>
  ...
  methods: {
    _initSecurity() {
      ...
      this._cleanupDevTools = watchDevTools(() => {
        ...
        sendLog('devtools', 'เปิด DevTools', { page: 'ddx' })
      })
    },
    _initSocket() {
      ...
      this._socket.on('connect', () => {
        ...
        const data = {
          sectionName: 'NINJA DDx',
          videoTitle: 'DDx Approach',
          tabId: this.tabId,
          os: ctx.os,
          browser: ctx.browser,
          contentType: 'ddx'
...
.exam-badge{background:#f97316;color:#fff;padding:2px 10px;border-radius:10px;font-size:11px;font-weight:700}
