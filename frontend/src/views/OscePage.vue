  ...
  <div class="exam-page" @contextmenu.prevent>
    ...
    <div v-else class="exam-container">
      <div class="exam-header">
        ...
        <h1 class="exam-title">NINJA OSCE</h1>
        <span class="exam-badge">Clinical Skills</span>
      </div>
      <div class="exam-body">
        <div class="coming-soon">
          <div class="cs-icon">🩺</div>
          <h2>กำลังพัฒนาเนื้อหา</h2>
          <p>ระบบจำลองสถานการณ์สอบ OSCE</p>
          <p class="cs-features">• ซ้อมซักประวัติเสมือนจริง<br>• ฝึกหัตถการแบบ Step-by-step<br>• Station-based ครบทุกสถานี</p>
        </div>
      </div>
    </div>
  </div>
  ...
  methods: {
    _initSecurity() {
      ...
      this._cleanupDevTools = watchDevTools(() => {
        ...
        sendLog('devtools', 'เปิด DevTools', { page: 'osce' })
      })
    },
    _initSocket() {
      ...
      this._socket.on('connect', () => {
        ...
        const data = {
          sectionName: 'NINJA OSCE',
          videoTitle: 'Clinical Skills',
          tabId: this.tabId,
          os: ctx.os,
          browser: ctx.browser,
          contentType: 'osce'
...
.exam-badge{background:#10b981;color:#fff;padding:2px 10px;border-radius:10px;font-size:11px;font-weight:700}
