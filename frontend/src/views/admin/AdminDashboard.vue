    ...
    <div class="container section">
      ...
      <div class="nav-section">
        ...
        <div class="admin-nav-grid">
          ...
          <router-link to="/admin/progress" class="admin-nav-card">
            <div class="nav-icon" style="background:linear-gradient(135deg,#0ea5e9,#3b82f6);color:#fff;">
              <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" width="22" height="22">
                <path stroke-linecap="round" stroke-linejoin="round" d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z"/>
              </svg>
            </div>
            <div class="nav-content">
              <h3>Progress นักเรียน</h3>
              <p>ใครดูไปแล้วเท่าไหร่ + จบ Topic ไหน (ไว้กระตุ้น/นัดปรึกษา)</p>
            </div>
            <svg class="nav-arrow" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" width="18" height="18"><path stroke-linecap="round" stroke-linejoin="round" d="M9 5l7 7-7 7"/></svg>
          </router-link>
