  ...
  <div class="exam-page" @contextmenu.prevent>
    ...
    <div v-else class="exam-container">
      <div class="exam-header">
        ...
        <h1 class="exam-title">NINJA Synapse</h1>
        <span class="exam-badge">E-Learning</span>
      </div>
      <div class="exam-body">
        <div class="coming-soon">
          <div class="cs-icon">🧠</div>
          <h2>กำลังพัฒนาเนื้อหา</h2>
          <p>ระบบ E-Learning เชื่อมโยง Anatomy Biochem Patho</p>
          <p class="cs-features">• เนื้อหา Anatomy + Biochem + Patho เชื่อมโยง<br>• Interactive Learning<br>• สรุปเนื้อหาครบจบในที่เดียว</p>
        </div>
      </div>
    </div>
  </div>
  ...
  methods: {
    _initSecurity() {
      ...
      this._cleanupDevTools = watchDevTools(() => {
        ...
        sendLog('devtools', 'เปิด DevTools', { page: 'synapse' })
      })
    },
    _initSocket() {
      ...
      this._socket.on('connect', () => {
        ...
        const data = {
          sectionName: 'NINJA Synapse',
          videoTitle: 'E-Learning System',
          tabId: this.tabId,
          os: ctx.os,
          browser: ctx.browser,
          contentType: 'synapse'
...
.exam-badge{background:#8b5cf6;color:#fff;padding:2px 10px;border-radius:10px;font-size:11px;font-weight:700}
