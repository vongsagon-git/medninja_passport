...
export default {
  ...
  getConsentStatus() {
    return api.get('/trial/consent/status')
  },

  // Student: accept consent for specific activation
  acceptConsent(activationId) {
    return api.post('/trial/consent/accept', { activationId })
  }
}
